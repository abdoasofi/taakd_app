...
<template>
	<div
	  :class="[
		'p-2 flex flex-row gap-2 justify-start  items-center transition-colors duration-300',
		processClass,
	...
	>
	  ...
	  <!-- تفاصيل المرحلة -->
	  <div
		class="ltr:ml-4 rtl:mr-4 flex flex-col justify-center mt-0"
		@mouseenter="onMouseEnter"
		@mouseleave="onMouseLeave"
	  >
		<span class="block  text-left rtl:text-right">{{ label }}</span>
		<span class="text-left rtl:text-right text-sm text-primary font-semibold">
		  {{ desc }}
		</span>
	  </div>
	</div>
