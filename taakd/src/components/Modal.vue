<template>
	<div class="relative flex flex-col items-center max-w-lg gap-4 p-6 rounded-md shadow-md sm:py-8 sm:px-12 dark:bg-gray-50 dark:text-gray-800">
		<button class="absolute top-2 end-2">
		...
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-40 h-40 fill-current shrink-0 dark:text-violet-600">
		...
		<p class="flex-1 text-center dark:text-gray-600">Tempora ipsa quod magnam non, dolores nemo optio. Praesentium soluta maiores non itaque aliquam sint.</p>
		<button type="button" class="px-8 py-3 font-semibold rounded-full dark:bg-violet-600 dark:text-gray-50">Start recycling</button>
	</div>
</template>
